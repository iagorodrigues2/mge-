...
interface ImportItem { empresa?: string; website?: string; cidade?: string; uf?: string; segmento?: string; whatsapp?: string; cnpj?: string; whatsapp_fonte?: string }
...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({ ok: true, created, skipped, existentes });
  } catch (e) {
